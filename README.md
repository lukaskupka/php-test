...
3. Setup page size parameters in `config/services.yaml` file in `parameters:` section
...
2. Build the Docker image: `docker-compose -f docker-compose build`
3. Start the Docker containers: `docker-compose -f docker-compose up -d`
